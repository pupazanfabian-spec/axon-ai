                  ...
                  <View style={styles.outputSection}>
                    ...
                    {result.stderr.length > 20 && (
                      <TouchableOpacity style={styles.fixBtn} onPress={handleAskFix}>
                        <Text style={styles.fixBtnText}>🤖 Cere Axon să corecteze eroarea</Text>
                      </TouchableOpacity>
                    )}
                  </View>
                ) : null}
            ...
            {tutorial ? (
              ...
              <View style={styles.noTutorial}>
                <Text style={styles.noTutorialText}>
                  ...
                  Poți cere Axon să îți explice orice concept!
                </Text>
                <TouchableOpacity
                ...
                >
                  <Text style={styles.askTutorialBtnText}>🤖 Cere tutorial de la Axon</Text>
                </TouchableOpacity>
              </View>
            )}
