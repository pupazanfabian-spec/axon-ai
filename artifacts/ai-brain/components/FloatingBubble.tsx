...
export default function FloatingBubble({ onSendToChat, onMemorize }: FloatingBubbleProps) {
  ...
  const handleCamera = useCallback(async () => {
    ...
    try {
      ...
      if (status !== 'granted') {
        Alert.alert('Permisiune refuzată', 'Axon nu poate accesa camera fără permisiune.');
  ...
  const handleGallery = useCallback(async () => {
    ...
    try {
      ...
      if (status !== 'granted') {
        Alert.alert('Permisiune refuzată', 'Axon nu poate accesa galeria fără permisiune.');
        setIsProcessing(false);
        return;
      }
          ...
          <View style={styles.previewCard}>
            ...
            <View style={styles.previewActions}>
              <TouchableOpacity style={styles.previewBtn} onPress={handleSendExtracted}>
                ...
                <Text style={styles.previewBtnText}>Trimite la Axon</Text>
              </TouchableOpacity>
