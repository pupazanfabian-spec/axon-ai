...
export default function ModelSetupScreen() {
  ...
  if (status === 'loading') {
    return (
      <View style={styles.container}>
        ...
        <Text style={styles.title}>Se încarcă Axon în memorie...</Text>
  ...
  if (status === 'downloading') {
    return (
      <View style={styles.container}>
        ...
        <Text style={styles.title}>Se descarcă creierul lui Axon</Text>
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.title}>Axon — Instalare inițială</Text>
      <Text style={styles.sub}>
        Pentru a funcționa cu adevărat inteligent, Axon are nevoie de creierul său neural.
      </Text>
