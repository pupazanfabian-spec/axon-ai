...
// Mintea lui Axon — sistem de gandire autonoma, asociere de idei si personalitate

import { Concept, CONCEPTS, findRelevantConcept, generateProactiveThought, AXON_PERSONALITY } from './knowledge';
...
export function generateChainOfThought(topic: string, concept: Concept | null): string[] {
  ...
  // Pasul 4: Opinia lui Axon (dacă există)
...
export function generateProactiveMessage(mindState: MindState, userName: string | null): string {
  ...
  // Gand din proprie initiativa - subiect aleator din interesele Axon
